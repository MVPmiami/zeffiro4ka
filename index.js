...
bot.hears('сук', (ctx) => {
  ctx.reply(`азазаза блять вот так-то!`)
})
bot.hears('сук)', (ctx) => {
  ctx.reply(`азазаза блять вот так-то!`)
})
...
bot.hears('сука блять', (ctx) => {
  ctx.reply(`азазаза блять вот так мешок ебаный!`)
})
bot.hears('сука блять нахуй', (ctx) => {
  ctx.reply(`азазаза блять вот так мешок!`)
})
bot.hears('сука блять пздц', (ctx) => {
  ctx.reply(`азазаза блять вот так мешок!`)
})
bot.hears('эт да', (ctx) => {
  ctx.reply(`хуй на`)
